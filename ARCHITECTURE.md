...
This document describes the internal architecture of Dasher, the LLVM-based AOT native compiler for santa-lang.
...
**Total codebase:** ~40,000 lines of Rust across 4 crates
...
## Code Generation (`lang/src/codegen/`)
...
The `dasher` binary embeds its runtime library, making it completely self-contained.
